...
<section class = "content c-standard">
	<div class="wrapper type-2">
		...
		<div class="box-desc">
			<div class="list">
				<b class = "c-gray3">Author :</b>
				<p class="m0 c-gray3">Juniman, Anup Khumar, Myrl Gunadarto</p>
			</div>
			<div class="list">
				<b class = "c-gray3">Language :</b>
				<p class="m0 c-gray3">Bahasa</p>
			</div>
			<div class="list">
				<b class = "c-gray3">Publisher :</b>
				<p class="m0 c-gray3">BSIM Treasury Division</p>
			</div>
			<div class="list">
				<b class = "c-gray3">Publication Date :</b>
				<p class="m0 c-gray3">December 5<sup>th</sup> 2018</p>
			</div>
		</div>
		<div class= "line-dashed"></div>
